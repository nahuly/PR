...
# all, any : iterable 요소 검사(참, 거짓) #하나라도 거짓이면 거짓 반환

print(all([1,2,3])) #하나라도 거짓이면 거짓 반환 and
print(any([1,2,0])) #하나라도 참이면 참 반환 or
# 리스트아니더라도 적용된다.
...
for i, name in enumerate(['abc','bcd','efg']): #두개를 한번에 표현가능
    print(i, name)
...
print(a)
print(sorted(['p','y','t','h','o','n'])) # 오름차순 정렬
...
# zio : 반복가능한 객체(Iterable)의 요소를 묶어서 반환
